			...
			<div class="container">
				<div class="form-group">
					...
					<?php
						...
						<textarea style="background-color: #474747; color:#999999;" name="combo" class="form-control" id="comboarea" rows="4" maxlength="255" title="combo" placeholder="Make sure to leave a space between every button. (Eg.: 2 A > 5 B > 236 C). Text can be added if needed."><?php 
							if(isset($_POST['type'])){
								if($_POST['type'] == 2){
									echo $_POST['combo'];
								}
