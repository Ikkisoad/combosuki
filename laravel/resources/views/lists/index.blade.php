            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                @auth
                    ...
                    <form class="form-control combosuki-main-reversed text-white" method="post" action="{{ route('lists.store') }}">
                        @csrf
                        <div class="mb-2">
                            <input placeholder="Guide Name" name="list_name" class="form-control" maxlength="100" value="{{ old('list_name') }}">
                        </div>
                        <div class="mb-2">
                ...
                <form class="form-control combosuki-main-reversed text-white" method="get" action="{{ route('lists.search') }}">
                    <div class="mb-2">
                        <input placeholder="Guide Name" name="list_name" class="form-control" maxlength="45" value="{{ request('list_name') }}">
                    </div>
                    <div class="mb-2">
                        <select name="game_idgame" class="form-select">
                            <option value="0">Game</option>
