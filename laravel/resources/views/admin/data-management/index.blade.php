<x-layouts.app title="Data Management">
    <x-nav-bar />
    ...
    <div class="container-fluid my-3">
        ...
        <h1 class="text-white">Data Management</h1>
        <p class="text-white">
        ...
        <form method="get" action="{{ route('admin.data-management') }}" class="card combosuki-main-reversed text-white p-3 mb-3">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-auto">
                    ...
                    <a href="{{ route('admin.data-management') }}" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>

        <form method="post" action="{{ route('admin.data-management.destroy') }}" id="bulk-delete-form">
            @csrf
